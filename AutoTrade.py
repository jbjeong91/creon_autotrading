...
def get_stock_balance(code):
    ...
    if code == 'ALL':
        dbgout('모든 계좌들:'+str(cpTradeUtil.AccountNumber))##jeong
        dbgout('설정 거래 계좌:'+str(cpTradeUtil.AccountNumber[0]))##jeong
...
if __name__ == '__main__': 
    try:
        ...
        while True:
            ...
            t_start = t_now.replace(hour=9, minute=5, second=0, microsecond=0) # LP활동시간기준
